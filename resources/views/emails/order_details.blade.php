...
@section('content')
    ...
    <p>Hemos recibido su orden y estos son los detalles de su compra:</p>
    ...
    <table class="table align-middle table-hover">
        ...
        <tbody>
            ...
            <tr>
                <td style="vertical-align: top; border-bottom: 1px solid #f0f0f0; padding: 4px 0px;"></td>
                <td style="vertical-align: top; border-bottom: 1px solid #f0f0f0; padding: 4px 0px;">
                    Pagaste: {{ number($order->total) }} <br>Con {{ getPaymentsMethods($order->payment_method) }}
                </td>
            </tr>
        </tbody>
    </table>
    <br><br>
    <a href="3" style="text-decoration: none;" class="btn btn-primary">Ver en mis compras</a>
@endsection